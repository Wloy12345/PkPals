...
{
    public class WaterIndexController : Controller
    {
        private PKPalsEntities db = new PKPalsEntities();

        // GET: WaterStatusIndex/WaterIndex
        ...
        // GET: WaterStatusIndex/WaterIndex/Details/5
        ...
        // GET: WaterStatusIndex/WaterIndex/Create
        ...
        // POST: WaterStatusIndex/WaterIndex/Create
        ...
        // GET: WaterStatusIndex/WaterIndex/Edit/5
        ...
        // POST: WaterStatusIndex/WaterIndex/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: WaterStatusIndex/WaterIndex/Delete/5
        ...
        // POST: WaterStatusIndex/WaterIndex/Delete/5
